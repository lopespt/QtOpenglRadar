...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Radar_t, stringdata) + ofs \
...
const QMetaObject Radar::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Radar.data,
      qt_meta_data_Radar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Radar.stringdata))
        return static_cast<void*>(const_cast< Radar*>(this));
